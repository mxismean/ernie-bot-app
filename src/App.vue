<template>
  <div class="box">
    <h1 class="title">文心一言</h1>
    <p class="btn" @click="onEnter">OPEN</p>
  </div>
</template>
...
onMounted(() => {
  // @ts-ignore
  // document.querySelector('html').style.zoom = 0.5;
});
</script>
...
.btn {
  ...
  text-align: center;
  border-radius: 10px;
  background-image: linear-gradient(to left, #14f7e4, #c7ea19, #0e9595, #1e67ec, #1af0c2);
  background-size: 400%;
}
.btn:hover {
